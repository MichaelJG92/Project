...
{
    char playerName[50];
    char playerColor1[25],playerColor2[25];
    char playerID;
};
...
int Checkfive ( char board[][10], playerInfo activePlayer );
...
int main()
{
    ...
    cout << "LET'S PLAY FIVE IN A ROW GAME" << endl << endl;
    cout << "PLAYER ONE PLEASE ENTER YOUR NAME: ";
    cin  >> playerOne.playerName;
    playerOne.playerID = 'X';
    cout << "PLEASE SELECT THE COLOR, RED OR BLUE: ";
    cin >> playerOne.playerColor1;
    cout << "PLAYER TWO PLEASE ENTER YOUR NAME: ";
    cin  >> playerTwo.playerName;
    playerTwo.playerID = 'O';
    cout << "PLEASE SELECT THE COLOR, RED OR BLUE: ";
    cin >> playerTwo.playerColor2;
...
int PlayerDrop( char board[][10], playerInfo activePlayer )
{
    ...
    }while ( dropChoice < 1 || dropChoice > 9 );
